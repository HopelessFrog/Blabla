...
{
    public class BottomFrame : BaseForm
    {
        private Text _heading => _controlsFactory.CreateControl<Text>(_form, "Sample heading", By.XPath(".//*[@id='sampleHeading']"));

        public string IframeLocator => ".//*[@id='frame2']";

        public BottomFrame(ControlsFactory controlsFactory, BrowserUtils browserUtils, IWebDriver driver, IOptionsSnapshot<BrowserConfiguration> config, ILogger? logger = null)
